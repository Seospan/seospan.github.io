        ...
        try {
            ...
            if (mapped) {
                ...
                for(rayon in shopping_list){
                    ...
                    console.log(rayon);
                    console.log(typeof(shopping_list[rayon]['items']['value']));
                    console.log(shopping_list[rayon]['items']['value']);
                    
                    var shopping_list_items = JSON.parse(shopping_list[rayon]['items']['value']);
